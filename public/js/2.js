...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(79)("c420dc4c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(79)("648b341c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(79)("b9557f26", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(79)("7b45937c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_slick__ = __webpack_require__(251);
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            "\n                        " +
                              _vm._s(_vm.brandItems[_vm.brandIndex].title) +
                              "\n                    "
                          )
                        ]
                      ),
                      ...
                      _c(
                        ...
                        {
                          staticClass:
                            "position-relative d-flex text-size-3 justify-content-center",
                          class: { fade: _vm.addTransition }
                        },
                        [
                          _c(
                            "router-link",
                            {
                              ...
                              attrs: {
                                to: _vm.brandItems[_vm.brandIndex].contact
                              }
                            },
                            [_vm._v("聯絡我們")]
                          ),
                          ...
                          _c(
                            ...
                            {
                              staticClass: "brands-link",
                              attrs: { to: _vm.brandItems[_vm.brandIndex].book }
                            },
                            [_vm._v("線上訂位")]
                          )
                        ],
                      ...
                      _c(
                        ...
                        [
                          _c("p", { staticClass: "position-relative" }, [
                            _vm._v(_vm._s(_vm.brandItems[_vm.brandIndex].title))
                          ]),
                          _vm._v(" "),
                          _c(
                            "div",
                            {
                              staticClass:
                                "d-flex text-size-3 justify-content-center position-relative"
                            },
                            [
                              _c(
                                "router-link",
                              ...
                              _c(
                                "router-link",
                                {
                                  staticClass: "brands-link",
                                  attrs: {
                                    to: _vm.brandItems[_vm.brandIndex].book
                                  }
                                },
                                [_vm._v("線上訂位")]
                              )
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(79)("125a11db", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
        ...
        _vm._l(_vm.viewIndex + 1, function(n, $groupIndex) {
          return _c(
            "div",
            {
              key: $groupIndex,
              staticClass:
                "news-list d-flex flex-lg-row flex-column-reverse flex-lg-column justify-content-between w-100 "
            },
            [
              _c(
                "div",
                {
                  staticClass:
                    "block-list beside flex-row d-flex justify-content-between"
                },
                _vm._l(
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(79)("e8adc522", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {

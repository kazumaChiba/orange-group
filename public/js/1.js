...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(31)("c420dc4c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(31)("648b341c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_block_experience__ = __webpack_require__(481);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_components_block_brands__ = __webpack_require__(486);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_components_block_news__ = __webpack_require__(491);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_components_block_foods__ = __webpack_require__(496);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_components_block_footer__ = __webpack_require__(398);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vue_fullpage_js__ = __webpack_require__(501);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vue2_scrollbar__ = __webpack_require__(502);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_perfect_scrollbar__ = __webpack_require__(503);
//
//
//
//
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(31)("b9557f26", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("div", {
            staticClass: "bg-inner position-absolute bg-black-cover",
            class: { active: _vm.bgTransition },
            style:
              "background-image:url(" +
            ...
            [
              ...
              _c(
                "div",
                {
                  ...
                  style: "transform: scale(1.05) rotate(" + _vm.rotate + "deg)"
                },
                [
                  _c(
                    "a",
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(31)("7b45937c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_slick__ = __webpack_require__(415);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        countIndex: function countIndex() {
            this.bgActive = true;
            var itemsLength = this.brandItems.length - 1;
        ...
        delayBg: function delayBg() {
            var _this = this;

            setTimeout(function () {
                _this.delayIndex = _this.indexBrand;
            }, 800);
            setTimeout(function () {
  ...
  return _c(
    ...
    [
      _c("div", {
        ...
        style:
          "background-image: url(" + _vm.brandItems[_vm.indexBrand].url + ")"
      }),
      _vm._v(" "),
      _c(
        "div",
        ...
        [
          _c(
            ...
            {
              staticClass:
                "row h-100 w-100 flex-column align-items-center justify-content-center d-md-flex d-none"
            },
            [
              _vm._m(0),
              _vm._v(" "),
                ...
                [
                  ...
                  _c(
                    "slick",
                    {
                      ref: "slick",
                      staticClass:
                        "content-brands d-flex align-items-center justify-content-center mt-5 mb-5",
                                ...
                                [
                                  ...
                                  _c(
                                    "a",
                                    {
                                      attrs: {
                                        href:
                                          _vm.brandItems[_vm.indexBrand].book
                                      }
                                    },
                                    [_vm._v("線上訂位")]
                                  )
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          {
                            staticClass:
                              "info-brands d-flex flex-column align-items-center position-relative border-radius-100 justify-content-center text-left"
                          },
                          [
                            _c("img", { attrs: { src: item.logo } }),
                            _vm._v(" "),
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-1e9078d8"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        ...
        return _ref = {
            ...
            newsIndex: 0,
            viewIndex: 0
        }, _defineProperty(_ref, 'newsCategories', ['橘色涮涮屋', 'Extension 1 by 橘色']), _defineProperty(_ref, 'category', ''), _ref;
    },
    methods: {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(31)("e8adc522", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {

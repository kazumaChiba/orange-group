...
var update = __webpack_require__(55)("7ed73c01", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_block_banner__ = __webpack_require__(116);
  ...
  return _c(
    ...
    [
      ...
      _c("div", { attrs: { id: "header" } }, [
        _c("div", { staticClass: "mt-5 d-flex position-fixed w-100" }, [
          _vm._m(0),
          _vm._v(" "),
          _c(
            "div",
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(55)("822c5f64", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
